layui.use(['table','form'], function(){
  ...
  var form = layui.form;
  var beforeURL = "/muda/patformPlan";
  ...
  csvo = table.render({
    ...
    ,cols: [
     [
      ...
      ,{field:'planName', title: '计划名称',sort: true, width:120, fixed: true}
      ,{field:'projectName', title: '项目名称',sort: true, width:150, fixed: true}
      ,{field:'caseList', title: 'case列表',sort: true, width:180, fixed: true}
  ...
  function openWin(editData,title,url,w,h,full) {
    	    ...
    	    var index = layer.open({
    	        ...
    	        console.log('----=-------=====----'+editData.planName);
    	            ...
    	            body.find("input[name='caseList']").val(editData.caseList);
