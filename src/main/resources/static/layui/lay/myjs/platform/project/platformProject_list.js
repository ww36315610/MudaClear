layui.use(['table','form'], function(){
  ...
  var form = layui.form;
  var beforeURL = "/muda/patformProject";
  ...
  csvo = table.render({
    ...
    ,cols: [
     [
      ...
      ,{field:'projectName', title: '项目名称',sort: true, width:150, fixed: true}
      ,{field:'plans', title: '关联计划', width:150, fixed: true}
...
//      layer.alert('编辑行：<br>'+ JSON.stringify(data))
        openWin(data,'修改信息','/muda/platform/project/platformProject_edit.html',700,750);
    }
  });
